...
class Connection {
   ...
   */
  function Connection () {
    $this->hostname = "tijd.ws";
    $this->username = "microbilling";
    $this->password = "password";
	$this->database = "microservicesbilling";
    $this->link_id  = mysql_connect($this->hostname,
                                    $this->username, 
                                    $this->password) or 
                      die(mysql_error());
  ...
  function Usedb ($db="test") {
    mysql_select_db($db) or die("Database connectie niet mogelijk: " . mysql_error());
  }
  ...
  function Query ($query) {
    ...
    $this->query_id = mysql_query($query,$this->link_id) or die("Unable to execute query: " . mysql_error());
    $this->numqueries++;
  }
